...
export function AliveMedallion({
  ...
  roles = [
    { label: 'Program Mgrs',  sub: 'cost & schedule' },
    { label: 'Manufacturing', sub: 'quality & FPY' },
    { label: 'MRO',           sub: 'fleet & sustainment' },
    { label: 'Compliance',    sub: 'ITAR & DFARS' },
  ],
  accent = '#b8975c',
      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Flight test telemetry streams via Kafka</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">ITAR · AS9100 · DFARS · row-level access · column masking</span>
          </div>
