/*
 * WizardLivePage — dbt-wizard live-build playback for Argent Aerospace.
 *
...
// Agent accent colors aligned with Argent Aerospace palette
...
export default function WizardLivePage() {
  ...
  if (!scenario || agents.length === 0 || events.length === 0) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="mono text-xs uppercase tracking-wider text-[var(--ink-soft)]">dbt-wizard live build</div>
  ...
  return (
    <div className="wizard-terminal mx-auto max-w-[1640px] px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <span
            ...
            style={{
              ...
              background: 'rgba(237,137,54,0.1)', color: 'var(--orange)', border: '1px solid rgba(237,137,54,0.35)',
            }}
          >
            <span
              style={{
          ...
          <span className="mono text-xs text-[var(--ink-soft)] uppercase tracking-wider">{scenario.request_id}</span>
          <span className="font-mono" style={{ color: 'var(--ink-muted)', fontSize: 13 }}>
            Step{' '}
            <span style={{ color: 'var(--orange)', fontWeight: 700 }}>{currentStep}/{totalSteps}</span>
            <span className="mx-2" style={{ color: 'var(--ink-soft)' }}>&middot;</span>
          ...
          >
            <div
              style={{
                ...
                height: '100%',
                background: complete ? '#145e36' : 'var(--orange)',
      ...
      <div
        className="mb-3 px-4 py-2.5 argent-card border-l-4 flex items-center gap-5 flex-wrap"
        style={{ borderLeftColor: 'var(--orange)' }}
      >
        <div className="min-w-0 flex-shrink" style={{ flex: '1 1 460px' }}>
          <div className="mono" style={{ fontSize: 10, marginBottom: 2, color: 'var(--orange)', textTransform: 'uppercase', letterSpacing: '0.12em' }}>
            Reliability &amp; Airworthiness · {scenario.timezone_label} · {scenario.requested_by}
          </div>
          <p
        ...
        <div className="font-mono text-[var(--ink-muted)] shrink-0" style={{ fontSize: 11 }}>
          Target: <span style={{ color: 'var(--orange)', fontWeight: 700 }}>{scenario.metric_code}</span>
        </div>
      </div>
      ...
      <div className="mb-3 grid gap-1.5" style={{ gridTemplateColumns: 'repeat(6, minmax(0, 1fr))' }}>
        {STEP_DEFS.map((s, idx) => {
          ...
          return (
            <div
              key={s.label}
              className="argent-card px-2.5 py-2 flex flex-col gap-0.5"
              style={{
            ...
            >
              <div
                ...
                style={{
                  ...
                  color: active ? 'var(--orange)' : done ? '#145e36' : 'var(--ink-soft)',
                }}
              >
      ...
      >
        ...
        <section
          className="argent-card flex flex-col lg:!h-[calc(100dvh-440px)]"
        ...
        >
          ...
          >
            <div>
              <div className="mono" style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.12em', color: 'var(--ink-soft)' }}>Sub-agent narration</div>
          ...
          >
            {visibleNarr.map((m, idx) => {
              ...
              const color = a?.color ?? AGENT_STEP_COLOR[m.e.from] ?? '#ed8936';
                      ...
                      <div className="flex items-center gap-2 flex-wrap mb-1.5">
                        ...
                        <span
                          ...
                          style={{
                            ...
                            background: 'rgba(237,137,54,0.10)', color: 'var(--orange)',
        ...
        <section className="flex flex-col gap-3 lg:!h-[calc(100dvh-440px)]" style={{ minHeight: 'max(60vh, 300px)' }}>
          ...
          {/* SQL panel */}
          <div className="argent-card flex flex-col" style={{ flex: '1.7 1 0' }}>
            <header
              className="px-5 py-3 border-b flex items-center justify-between"
              style={{ borderColor: 'var(--hairline)' }}
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="mono font-mono" style={{ fontSize: 11, letterSpacing: '0.02em', textTransform: 'uppercase', color: 'var(--ink-soft)' }}>
                  models/gold/fct_removal_by_part_route_corridor_60d.sql
                </div>
                <span
          ...
          {/* YAML panel */}
          <div className="argent-card flex flex-col" style={{ flex: '1 1 0' }}>
            <header
              className="px-5 py-3 border-b flex items-center justify-between"
              style={{ borderColor: 'var(--hairline)' }}
            >
              <div className="flex items-center gap-3 flex-wrap min-w-0">
                <div className="mono font-mono" style={{ fontSize: 11, letterSpacing: '0.02em', textTransform: 'uppercase', color: 'var(--ink-soft)' }}>
                  models/gold/fct_removal_by_part_route_corridor_60d.yml
                </div>
                <span
                  className="layer-chip"
                  style={{
      ...
      <div className="argent-card mt-2 px-3 py-2 flex items-center gap-3">
        <div className="mono shrink-0" style={{ fontSize: 10, textTransform: 'uppercase', letterSpacing: '0.12em', color: 'var(--ink-soft)' }}>tool calls</div>
              ...
              >
                <span
                  style={{
                    ...
                    background: i === 0 ? 'var(--orange)' : 'var(--ink-soft)',
      ...
      {complete && (
        <div
          className="mt-6 argent-card p-5"
          style={{
            borderLeft: '5px solid #145e36',
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              <div
                ...
                style={{
                  ...
                  background: 'rgba(20,94,54,0.12)', color: '#145e36',
                  border: '1px solid rgba(20,94,54,0.35)',
                }}
              >
                Build Complete
              </div>
              <span className="mono text-xs text-[var(--ink-soft)] uppercase tracking-wider">{scenario.request_id} · {scenario.company}</span>
            </div>
            <Link
              to="/wizard-outcome"
              className="inline-flex items-center gap-2 rounded-sm font-semibold transition-colors"
              style={{
                background: 'var(--orange)', color: 'var(--gunmetal-deep)',
      ...
      <style>{`
        ...
        .wizard-terminal::after {
          content: 'argent-aerospace/wizard-live · dbt-wizard';
          position: absolute;
          top: 0; left: 0; right: 0;
          height: 28px;
          display: flex;
        ...
        .wizard-terminal .argent-card {
          background: var(--t-surface) !important;
          border-color: var(--t-line) !important;
          color: var(--t-text);
          box-shadow: none;
        }
        .wizard-terminal .argent-card header,
        .wizard-terminal .argent-card > .border-b {
          border-color: var(--t-line) !important;
          background: var(--t-elev);
        }
        /* Inner narration scroll surface */
        .wizard-terminal .argent-card > div[style*="background: var(--paper)"] {
        ...
        .wizard-terminal .mono {
          color: var(--t-accent) !important;
          opacity: 0.85;
        }
        /* Step rail active/done tiles */
        .wizard-terminal .argent-card[style*="rgba(237,137,54"] {
          background: rgba(246,173,85,0.10) !important;
        }
        .wizard-terminal .argent-card[style*="rgba(20,94,54"] {
          background: rgba(74,222,128,0.10) !important;
        }
        .wizard-terminal .argent-card[style*="var(--paper-deep)"] {
          background: var(--t-surface) !important;
        }
        /* Code panels */
        .wizard-terminal pre {
        ...
        /* Question banner */
        .wizard-terminal .argent-card.border-l-4 {
